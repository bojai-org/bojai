...
class dataFormatManager():
    ...
    def process(self, task, data_dir,data_sep): 
        ...
        if task == "clt":
            processor = DataFormatterCLNGET(data_dir)
...
class DataFormatterCLNGET(DataFormater):
    def __init__(self, data_dir):
    ...
    def convertJson(self, data_dir):
        ...
        with open(input_file, 'w', encoding='utf-8') as input_txt, open(output_file, 'w', encoding='utf-8') as output_txt:
            for entry in data:
