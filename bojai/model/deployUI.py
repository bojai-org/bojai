...
class DeployWindow(QWidget):
    ...
    def evaluate_data_layout(self):
        ...
        update_title = QLabel("Evaluate your model. Once you add a new evaluation data you can use it to get the evaluation score.")
        update_title.setStyleSheet("font-size: 16px; color: black;")
    ...
    def create_data_view_section(self):
        ...
        update_title = QLabel("Add a new evaluation data, leave empty if you want to use your original data or enter a file to evaluate other data.")
        update_title.setStyleSheet("font-size: 16px; color: black;")
    ...
    def save_model_layout(self):
        ...
        update_title = QLabel("Download your model as a .bin file locally, enter the folder address.")
        update_title.setStyleSheet("font-size: 16px; color: black;")
    ...
    def download_model(self):
        ...
        try:
            if os.path.isdir(where) == False: 
                ...
                save_path = os.path.join(where, self.deploy.trainer.model.__class__.__name__ + '.bin') 
