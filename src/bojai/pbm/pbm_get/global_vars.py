...
def getNewModel():
    return FineTunedTransformerGET("huawei-noah/TinyBERT_General_4L_312D", vocab_size=len(getNewTokenizer()))
...
task_type = 'get'
hyper_params = {'batch_size': 32,'learning_rate': 1e-5,'num_epochs': 1,'num_workers' : 0}
options = {}