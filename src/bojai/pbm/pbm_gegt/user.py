...
class UserGet(User):
    ...
    def use_model(self, input_image: Image.Image):
            ...
            start_token = self.tokenizer[1].pad_token_id  # or another start token, depending on your setup
            ...
            with torch.no_grad():
                ...
                generated_text = self.tokenizer[1].decode(predicted_token_ids[0], skip_special_tokens=True)

            return generated_text
    


model = FineTunedTransformerGEGT(vocab_size=30522)  # Specify the vocab size (e.g., from a pretrained model)
...
UserGet(model, tokenizer, device, 10).use_model("C:\\Users\\soghm\\OneDrive\\Desktop\\me.jpg")