...
class Train:
    def __init__(self, prep: Prepare, hyper_params):
        with Timer("initialising Train phase"):
            self.hyper_params = hyper_params
            self.prep = prep
            self.trained = False
            if self.prep.prep_ready:
                with Timer("Train phase - getting training tools"):
            ...
            with Timer("Train phase - init model"):
                init_model(self.prep.data, self.model, hyper_params)
            
            with Timer("Train phase - training manager"):
            ...
            with Timer("Training phase - initialise:"):
